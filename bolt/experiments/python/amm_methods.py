...
METHOD_TO_ESTIMATOR = {
    ...
    METHOD_VINGILOTE: vq_amm.VingiloteMatmul,
...
HEDGEHOG_METHODS = (METHOD_VINGILOTE, METHOD_PLUTO)
VQ_METHODS = PQ_METHODS + BOLT_METHODS + MITHRAL_METHODS + HEDGEHOG_METHODS
...
USE_METHODS = ((METHOD_EXACT, METHOD_BOLT, METHOD_MITHRALPQ, METHOD_MITHRAL)
               + HEDGEHOG_METHODS
               + FAST_SKETCH_METHODS)
USE_METHODS = tuple(set(USE_METHODS) - {METHOD_BOLT, METHOD_PCA, METHOD_SPARSE_PCA, METHOD_PLUTO})
